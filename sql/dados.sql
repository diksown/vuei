...
VALUES ('j_silva@jmail.com', 'João Silva', 'R$w#2gFq7P', '(11)99876-5432', format_date('1997/10/12')),
       ...
       ('thmiranda@jmail.com', 'Thiago Miranda', 'ZcM3*S@bYg', '(82)94321-6789', format_date('1996/12/08')),
       ...
       ('lucasrodrigues@yohoo.com', 'Lucas Rodrigues', 'R$3QzVqT@j', '(44)34567-8901', format_date('1990/11/25')),
